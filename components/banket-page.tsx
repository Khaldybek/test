  ...
  return (
    ...
    >
      <main className="flex min-h-dvh flex-col px-5 pb-12 pt-6" lang="kk">
        ...
        <FadeIn className="banket-hero mt-12 text-center">
          <p className="font-names text-[2.75rem] font-medium italic leading-tight text-[#1a1012]">
            {COUPLE.groom}
          </p>
          <p className="font-names my-3 text-3xl font-normal not-italic text-accent">&</p>
          <p className="font-names text-[2.75rem] font-medium italic leading-tight text-[#1a1012]">
            {COUPLE.bride}
          </p>
          <p className="mt-8 font-serif text-xl tracking-[0.25em] text-foreground">
